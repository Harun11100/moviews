...
function Search(){
  ...
  function ResultsMassage({movies}){
  ...
  function SinglelistForeach({movies}){
  ...
  function MovieLists({children}){
    ...
    {/* chil use of Component composition */}
    {isOpen1 && (children
    )}
...
export default function App() {
  ...
  return (
    ...
    <Main>
      <MovieLists >
        <SinglelistForeach movies={movies}/>
      </MovieLists>
      <WatchedMovie/>
    </Main>
    </>
